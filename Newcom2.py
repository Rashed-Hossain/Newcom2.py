...
B = '\x1b[1;94m--------------------------------------------------------------
R = '\x1b[1;91mHACKING IS NOT CRIME IT’S A GAME AGAINST OF THE SYSTEM
G = '\x1b[1;92mSHARIATPUR DHAKA BANGLADESH
W = \x1b[1;93m'NAME' : 'RASHEDHOSSAIN
S = \x1b[1;96m'CYBER 'NAME'💣'HAT HACKERS 💣
P = \x1b[1;95m'WHATSAPP NO :  👬'+27618543540 👬
'Y'= '\x1b[1;93mWARNING :  👉 'DON,T CALL ME ONLY TEXT🔫
...
def pilog():
    ...
    if og == '1':
        ...
        sav.write(token)
        sav.close()
        print '\r\x1b[1;32m[\xe2\x9c\x93] RASHED Login Succesfully\x1b[0;97m'
        os.system('xdg-open https://youtube.com/channel/UCCn7b13eoRh24JeO0gE-0qQ')
        time.sleep(1)
        bot_fl()
    elif og == '0':
...
def bot_fl():
    try:
        ...
        print '\x1b[1;97m   [!] RASHED Token invalid'
...
def menu():
    ...
    print 'Please select'
    print ' '
    print "Don't Copy Me Because I Am Your Won’t Say anything"
    print ' '
    print '[1] Start Hacking With RASHED'
    print '[\x1b[91m0\x1b[0m] RASHED Exit'
    pil()
...
def cramen():
    ...
    print '[\x1b[91m0\x1b[0m] RASHED Back'
    crapil()
...
def crapil():
    ...
    print '\x1b[1;95mRASHED Process Has Been Completed Press\xe2\x9e\xa1 Type 0 Enter\xe2\x86\xa9 Next Type 0 (logout)\xe2\x86\xa9\x1b[1;97m....'
    raw_input('Back')
    menu()
